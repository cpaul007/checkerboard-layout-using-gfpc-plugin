...
add_filter( 'body_class', 'checkerboard_body_class' );
function checkerboard_body_class( $classes ) {
...
function checkerboard_enqueue_scripts() {
	...
	//* Loading checkerboard CSS
  	wp_enqueue_style( 'checkerboard', get_stylesheet_directory_uri() . '/checkerboard.css', array(), CHILD_THEME_VERSION );
}

//* Remove genesis default loop  
remove_action('genesis_loop', 'genesis_do_loop');

add_action('genesis_loop', 'checkerboard_widget_area');
function checkerboard_widget_area() {
